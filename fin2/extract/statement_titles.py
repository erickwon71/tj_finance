...
# ★ 추가: statement 명 뒤에 한글이 바로 이어지면(="현금흐름표의 현금은…", "재무상태표에 인식된…")
# 이는 표제 토큰이 아니라 **문장 속 명사구**(주석/보충표) → (?![가-힣]) 로 배제.
# 본문 표제는 statement 명이 단독 토큰("현금흐름표 제42기", "재무상태표 (단위:원)")이라 뒤가 공백·괄호·끝.
