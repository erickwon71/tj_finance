...
## Master checklist (copy into docs/prd/09_improvement_roadmap.md)

### Phase A — Ops
- [ ] A0 Save this roadmap as `docs/prd/09_improvement_roadmap.md`
- [ ] A1a Confirm 19:00 backup ran (logs + new dump in /Volumes/dart_data/db_backups, rotation working)
- [ ] A1b Restore drill into scratch DB + `docs/runbook_backup_restore.md`
- [ ] A2 Bootout + remove `com.dart.financial.worker` plist
...
- [ ] A4a D3 valuation_daily matview + refresh in collect_new.py
- [ ] A4b D5 weekly VACUUM/ANALYZE job
- [ ] A4c schema_migrations governance
